...
namespace Vendas.Persistencia
{
    public class VendaBD
    {
        public bool Insert(Venda venda)
        {
            ...
            string sql = "INSERT INTO ven_venda(ven_codigo, ven_cliente, ven_endereco, ven_bairro, ven_numero, ven_cnpj, ven_telefone, ven_nome, ven_quantidade, ven_valor, ven_data) VALUES (?codigo, ?cliente, ?endereco, ?bairro, ?numero, ?cnpj, ?telefone, ?nome, ?quantidade, ?valor, ?data)";
        ...
        public bool Update(Venda venda)
        {
            System.Data.IDbConnection objConexao;
            System.Data.IDbCommand objCommand;
            string sql = "UPDATE ven_venda SET ven_cliente=?cliente, ven_endereco=?endereco, ven_bairro=?bairro, ven_numero=?numero, ven_cnpj=?cnpj, ven_telefone=?telefone, ven_nome=?nome, ven_quantidade=?quantidade, ven_valor=?valor, ven_data=?data WHERE ven_codigo =?codigo";
